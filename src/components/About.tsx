      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-900/50 p-6 rounded-lg">
          ...
          <ul className="text-gray-300 space-y-2">
            <li>• <strong className="text-white">215+ PRs</strong> merged across open-source projects </li>
            <li>• <strong className="text-white">$6000 bounty</strong> awarded by <a href="https://flexile.com/" className="underline hover:text-accent transition-colors">Flexile</a> for major contributions to <strong className="text-white">antiwork</strong></li>
            <li>• Earned <strong className="text-white">$1099 bounty</strong> via <a href="https://algora.io/Anshgrover23/profile" className="underline hover:text-accent transition-colors">algora.io</a> for contributions to <strong className="text-white">open-source</strong></li>
